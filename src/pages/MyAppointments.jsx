                    ...
                    <div key={index} className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-4 border-b'>
                        <div>
                            <img
                                ...
                                src={item.docData?.image || assets.default_profile}
                                alt=""
                                onError={e => { e.target.onerror = null; e.target.src = assets.default_profile }}
                            />
                        </div>
                        <div className='flex-1 text-sm text-[#5E5E5E]'>
                            <p className='text-[#262626] text-base font-semibold'>{item.docData?.name || "Doctor"}</p>
